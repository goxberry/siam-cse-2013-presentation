...
## We can fix these problems...we have the technology
...
- Mathematical proof is one form of reproducibility
    + Originated with Greek mathematicians (~400 BC)
...
## Reproducible research = "post paper and all supporting materials"
...
## Reaping benefits of reproducible research reduces to habits and practices
...
## Tools enable adopting these practices at reasonable cost
...
## Version control systems track all code changes in repositories
...
## Web sites exist to host version control repositories
...
## Tools lessen burden of reproducible research
...
## Despite reducing burden of reproducible research with tools, challenges remain
...
## Reproducible research practices: a solution _resisted_
...
## Ultimately, reproducible research is about verification, transparency, and efficiency
...
## Available tools let you do reproducible research without really trying
